...
import profileCostIcon from '../../../../../../assets/images/cost-icon.png'
import profileCostIconActive from '../../../../../../assets/images/cost-icon.png'
import {connect} from "react-redux";
import EditIntroDialog from "./EditCostDialog";
...
function EditCost(props) {
    ...
    return (
        <>
            <EditIntroDialog show={showEdit} handleClose={editToggle}/>
            <Grid container spacing={1} justify='space-between' alignItems="flex-end" style={{margin:'8px 0'}} >
                <Grid item container md={9} xs={11} className={classes.profileFieldWrapper}>
                <Grid item>
                    <img   src={active?profileCostIconActive:profileCostIcon}  style={{width: 24 , marginTop:16}}/>
                </Grid>
                <Grid item>
