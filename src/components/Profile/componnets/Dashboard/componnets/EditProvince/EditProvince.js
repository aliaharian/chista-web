...
import userProvinceIcon from '../../../../../../assets/images/pin-icon.svg'
import userProvinceIconActive from '../../../../../../assets/images/pin-icon.svg'
...
function EditProvince(props) {
  ...
  return (
            ...
            <>
            <EditProvinceDialog show={showEdit} handleClose={closeEdit}/>
            <Grid container spacing={1} justify='space-between' alignItems="flex-start" style={{margin:'8px 0',width:"100%"}} >
                <Grid item container md={9} xs={11} className={classes.profileFieldWrapper}>
                    <Grid item>
                        <img   src={active?userProvinceIconActive:userProvinceIcon}  style={{width:24}}/>
                    </Grid>
                    <Grid item>
