...
export default function FaqItem({ q }) {
    const [isOpen, setOpen] = useState(false)
    return (
        <div
            onClick={() => { setOpen(!isOpen) }} 
            className={isOpen ? Style.faqPriceContainer + " " + Style.faqPriceOpened : Style.faqPriceContainer}
        >
            <div>
                 <Typography>
                     {q.title}
                 ...
                 <div>
                    <svg className={isOpen ? Style.faqPriceIconOpened : Style.faqPriceIconClosed} id="Group_15699" data-name="Group 15699" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
